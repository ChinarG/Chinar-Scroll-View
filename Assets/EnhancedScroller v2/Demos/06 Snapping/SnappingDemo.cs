...
{
    /// <summary>
    /// This demo shows how you can use snapping to lock a slot unit to a particular
    /// spot in the CScrollView when the CScrollView's velocity dips below a certain 
    ...
    public class SnappingDemo : MonoBehaviour
    {
        ...
        /// <summary>
        /// The number of CScrollViews that have snapped and stopped
        ...
        /// <summary>
        /// The minimum and maximum values that each CScrollView
            ...
            set
            {
                ...
                switch (_gameState)
                {
                    case GameStateEnum.Playing:
                        ...
                        // turn on the snapping for each CScrollView in the slot controllers
                        foreach (var slotController in _slotControllers)
                        {
                            slotController.CScrollView.snapping = true;
                        }
        ...
        void Awake()
        {
            ...
            foreach (var slotController in _slotControllers)
            {
                slotController.CScrollView.CScrollViewSnapped = CScrollViewSnapped;
            }
        }
        ...
        public void PullLeverButton_OnClick()
        {
            ...
            // loop through each slot controller and add a random velocity and direction to the CScrollViews
            foreach (var slotController in _slotControllers)
            {
        ...
        /// <summary>
        /// This is the handler of each snapping in the CScrollView. The 
        /// unit index will only be different from the data index if looping is on.
        /// </summary>
        /// <param name="CScrollView">The EnhancedCScrollView that fired the event</param>
        /// <param name="unitIndex">The index of the unit that snapped on</param>
        /// <param name="dataIndex">The data index of the unit that snapped on</param>
		private void CScrollViewSnapped(CScrollView CScrollView, int unitIndex, int dataIndex, CScrollUnitUi unitUi)
        {
            ...
            // set the slot of the snapped CScrollView for use in tallying the score
